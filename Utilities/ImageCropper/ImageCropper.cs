/// All credit for this class so far as I know goes to Jeff Bowman
/// this is the link I copied it from.
///https://github.com/jbowmanp1107/ImageCropper.Maui/blob/main/ImageCropper.Maui/ImageCropper.cs
...
namespace MyDoggyDetails.Utilities.Pictures
{
    public class ImageCropper
    {
        ...
        /// </summary>
        public string CropButtonTitle { get; set; } = "Save";
